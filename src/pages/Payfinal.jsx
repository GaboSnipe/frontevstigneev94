  ...
  return (
    <div className='container' style={{ display: 'flex', flexDirection: 'column'}}>
      <div className="selected-products-grid mx-auto">
        ...
        <img
          src={`https://https://backendevstigneev94.onrender.com/uploads/1.png`}
        ...
        <div style={{ width: '18vw', maxWidth: '400px'  }}>
          <img
            src={`https://https://backendevstigneev94.onrender.com/uploads/2.png`}
      ...
      <div className="selected-products-grid mx-auto">
        <div style={{ width: '18vw', maxWidth: '400px'  }}>
          <img
            src={`https://https://backendevstigneev94.onrender.com/uploads/3.png`}
        ...
        <div style={{ width: '18vw', maxWidth: '400px'  }}>
          <img
            src={`https://https://backendevstigneev94.onrender.com/uploads/4.png`}
