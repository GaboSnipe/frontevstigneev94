        ...
        <div className="form-control w-full lg:max-w-xs">
          ...
          <div className="form-control w-full lg:max-w-xs">
            <label className="label ">
             ...
             <img onClick ={()=> handleChangeFile}  className="centered-image " variant="outlined" size="large" src={`https://backendevstigneev94-production.up.railway.app${userFormData?.avatarUrl}`} />
            </label>
          </div>
