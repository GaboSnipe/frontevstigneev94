  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column' }}>
      <div className="selected-products-grid mx-auto">
        ...
        <img
          src={`https://backendevstigneev94.vercel.app/uploads/1.png`}
        ...
        <div style={{ width: '23vw' }}>
          <img
            src={`https://backendevstigneev94.vercel.app/uploads/2.png`}
      ...
      <div className="selected-products-grid mx-auto">
        <div style={{ width: '23vw' }}>
          <img
            src={`https://backendevstigneev94.vercel.app/uploads/3.png`}
        ...
        <div style={{ width: '23vw' }}>
          <img
            src={`https://backendevstigneev94.vercel.app/uploads/4.png`}
