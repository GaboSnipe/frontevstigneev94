...
const Register = () => {
  ...
  const checkcode = () => {
    ...
    fetch(`https://backendevstigneev94-production.up.railway.app/user/checkmailend`, {
      method: "POST",
    ...
    .then((res) => {
      ...
      fetch(`https://backendevstigneev94-production.up.railway.app/auth/register`, {
        method: "POST",
        headers: { "content-type": "application/json" },
  ...
  const handleSubmit = (e) => {
    ...
    if (isValidate()) {
      fetch(`https://backendevstigneev94-production.up.railway.app/user/checkmailstart`, {
        method: "POST",
        headers: { "content-type": "application/json" },
