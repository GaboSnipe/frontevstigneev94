        ...
        <div className="form-control w-full lg:max-w-xs">
          ...
          <div className="form-control w-full lg:max-w-xs">
            <label className="label ">
             ...
             <img onClick ={()=> handleChangeFile}  className="centered-image " variant="outlined" size="large" src={`https://https://backendevstigneev94.onrender.com${userFormData?.avatarUrl}`} />
            </label>
          </div>
